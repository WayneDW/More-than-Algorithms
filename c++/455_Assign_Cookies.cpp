...
// to increase the speed, idea: because the vector is inefficient, we use array instead
// https://discuss.leetcode.com/topic/76756/39ms-c-solution

int main() {
    Solution s;
    Examples eg;
    vector<int> vec{1,2,3}, ss{3};
    cout << s.findContentChildren(vec, ss) << endl;
}
